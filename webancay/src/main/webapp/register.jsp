...
<head>
    ...
    <title>Đăng ký - Cây Xanh Việt</title>
    <link href="https://fonts.googleapis.com" rel="preconnect">
    <link crossorigin="" href="https://fonts.gstatic.com" rel="preconnect">
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;700;800&amp;display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet">
    <link rel="stylesheet" href="fonts/style.css">
    <link rel="stylesheet" href="fonts/register.css">
</head>
<body class="light">
    ...
    <main class="main-content">
        <div class="container">
            <div class="register-container">
                ...
                <!-- Hiển thị lỗi chung -->
                <c:if test="${not empty fieldErrors and not empty fieldErrors.general}">
                ...
                <form action="register" method="POST" id="registerForm">
                    <div class="form-group">
                        <div class="form-row">
                            <div>
                                <label class="form-label" for="last-name">Họ</label>
                                ...
                                <c:if test="${not empty fieldErrors.lastName}">
                                    <div class="field-error">${fieldErrors.lastName}</div>
                                </c:if>
                            </div>
                            <div>
                                ...
                                <c:if test="${not empty fieldErrors.firstName}">
                                    <div class="field-error">${fieldErrors.firstName}</div>
                                </c:if>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="radio-group">
                            <div class="radio-option">
                                ...
                                <label class="radio-label" for="gender-female">Nữ</label>
                            </div>
                            <div class="radio-option">
                                <input class="radio-input"
                                       id="gender-male"
                                ...
                                <label class="radio-label" for="gender-male">Nam</label>
                            </div>
                        </div>
                        <c:if test="${not empty fieldErrors.gender}">
                            <div class="field-error">${fieldErrors.gender}</div>
                        </c:if>
                    </div>
                ...
                <div class="login-promo">
                    Đã có tài khoản?
                    <a class="login-link-blue" href="login.jsp">Đăng nhập ngay</a>
                </div>
...
<c:if test='${not empty registerSuccess and registerSuccess}'>show
</c:if>" id="successPopup">
    <div class="success-popup-content">
        <h3 class="success-popup-title">Đăng ký thành công!</h3>
        <p class="success-popup-message">
            Tài khoản của bạn đã được tạo thành công.<br>
            Vui lòng kiểm tra email để xác nhận tài khoản.
        </p>
        <a href="login.jsp" class="success-popup-button">Đóng</a>
    </div>
</div>
