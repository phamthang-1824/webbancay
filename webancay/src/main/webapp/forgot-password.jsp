...
<head>
    ...
    <title>Khôi phục mật khẩu - Cây Xanh Việt</title>
    <link href="https://fonts.googleapis.com" rel="preconnect">
    <link crossorigin href="https://fonts.gstatic.com" rel="preconnect">
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;700;800&amp;display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet">
    <link rel="stylesheet" href="fonts/style.css">
    <link rel="stylesheet" href="fonts/forgot-password.css">
</head>
<body class="light">
    ...
    <main class="main-content">
        <div class="container">
            <div class="forgot-password-container">
                <h1 class="forgot-password-title">Phục hồi mật khẩu</h1>
                ...
                <c:if test="${not empty success}">
                    <div class="success-message">
                        ...
                        <h2>Thành công!</h2>
                        <p>${success}</p>
                        <a href="login.jsp" class="btn-back">Quay lại đăng nhập</a>
                    </div>
                </c:if>

                <!-- Form phục hồi mật khẩu - chỉ hiển thị khi không có success -->
                <c:if test="${empty success}">
                    <form class="forgot-password-form" action="forgot-password" method="POST">
                        ...
                        <div class="forgot-password-buttons">
                            <a href="login.jsp" class="btn-cancel">Hủy</a>
