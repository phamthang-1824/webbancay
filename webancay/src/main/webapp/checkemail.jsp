...
<head>
    ...
    <title>Kiểm tra email - Cây Xanh Việt</title>
    <link href="https://fonts.googleapis.com" rel="preconnect">
    <link crossorigin href="https://fonts.gstatic.com" rel="preconnect">
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;700;800&amp;display=swap" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined" rel="stylesheet">
    <link rel="stylesheet" href="fonts/style.css">
    <link rel="stylesheet" href="fonts/check-email.css">
</head>
<body class="light">
    ...
    <main class="main-content">
        <div class="container">
            <div class="check-email-container">
                <span class="material-symbols-outlined check-email-icon">mail</span>

                <h1 class="check-email-title">Kiểm tra email của bạn</h1>
                ...
                <p class="check-email-message">
                    Vui lòng kiểm tra hộp thư đến và thư mục spam để nhận liên kết đặt lại mật khẩu.
                </p>

                <div class="check-email-instructions">
                    <div class="instruction-item">
                        <span class="material-symbols-outlined instruction-icon">check_circle</span>
                        <span>Mở email từ <strong>Cây Xanh Việt</strong></span>
                    </div>
                    <div class="instruction-item">
                        <span class="material-symbols-outlined instruction-icon">check_circle</span>
                        <span>Nhấp vào liên kết "Đặt lại mật khẩu" trong email</span>
                    </div>
                    <div class="instruction-item">
                        <span class="material-symbols-outlined instruction-icon">check_circle</span>
                        <span>Đặt mật khẩu mới cho tài khoản của bạn</span>
                    </div>
                    <div class="instruction-item">
                        <span class="material-symbols-outlined instruction-icon">check_circle</span>
                        <span>Liên kết có hiệu lực trong <strong>24 giờ</strong></span>
                    </div>
                </div>

                <div class="check-email-buttons">
                    ...
                    <a href="login.jsp" class="btn-back-to-login">
                ...
                <p class="footer-note">
                    ...
                    <a href="contact.jsp">liên hệ hỗ trợ</a>.
                </p>
            </div>
        </div>
    </main>
